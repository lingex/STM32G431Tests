...
#define DIS_R1_Pin GPIO_PIN_2
#define DIS_R1_GPIO_Port GPIOC
#define DIS_R2_Pin GPIO_PIN_3
#define DIS_R2_GPIO_Port GPIOC
#define DIS_CS_Pin GPIO_PIN_0
#define DIS_CS_GPIO_Port GPIOA
#define DIS_B2_Pin GPIO_PIN_1
#define DIS_B2_GPIO_Port GPIOA
#define LPUART1_TX_Pin GPIO_PIN_2
#define LPUART1_TX_GPIO_Port GPIOA
#define LPUART1_RX_Pin GPIO_PIN_3
#define LPUART1_RX_GPIO_Port GPIOA
#define DIS_B1_Pin GPIO_PIN_0
#define DIS_B1_GPIO_Port GPIOB
...
#define DIS_G2_Pin GPIO_PIN_10
#define DIS_G2_GPIO_Port GPIOC
#define DIS_CLK_Pin GPIO_PIN_11
#define DIS_CLK_GPIO_Port GPIOC
#define DIS_G1_Pin GPIO_PIN_12
#define DIS_G1_GPIO_Port GPIOC
